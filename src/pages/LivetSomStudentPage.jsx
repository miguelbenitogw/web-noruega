        ...
        <div className="container-xl">
          <div className="max-w-3xl mx-auto">
            <AnimateIn>
              ...
              />
              <a
                href="/spansk-i-alicante/helsenorsk"
                onClick={() => trackEvent('cta_click', { location: 'livet_helse', cta: 'helsenorsk' })}
                className="mt-4 inline-flex items-center gap-2 text-primary-600 font-semibold text-sm hover:text-primary-700 transition-colors"
              >
                Les mer om helsenorskprogrammet
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" aria-hidden="true"><path d="M5 12h14M12 5l7 7-7 7" /></svg>
              </a>
            </AnimateIn>
          </div>
