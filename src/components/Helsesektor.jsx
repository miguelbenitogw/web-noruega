            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -left-6 bg-white rounded-2xl shadow-xl p-5 border border-gray-100">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <div className="font-heading font-bold text-2xl text-ink">95%</div>
                    <div className="text-gray-400 text-xs">Retensjonsgrad</div>
                  </div>
                </div>
              </div>

              <div className="absolute -top-4 -right-4 bg-cta text-white rounded-2xl px-5 py-3 shadow-lg font-heading font-semibold text-sm">
                #1 i Norge
              </div>
            </div>
          </AnimateIn>
