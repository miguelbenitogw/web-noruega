        ...
        <div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
          <div className="min-w-0">
            ...
            <h1 className="mt-3 font-heading text-2xl font-bold text-white">
              Edición visual por secciones
            </h1>
            <p className="mt-1 text-sm text-slate-300">
              Canvas real al centro, estructura editorial a la derecha. Concepto primero, edición después. COMO TIENE QUE SER.
            </p>
          </div>
        ...
        <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="flex flex-col gap-2 sm:flex-row sm:items-center">
            ...
            <div className="rounded-2xl border border-white/10 bg-white/5 px-4 py-2.5 text-sm text-slate-300">
              Editá directo en el canvas y usá el panel para orientarte por secciones/campos.
            </div>
          </div>
        </div>
      </div>
