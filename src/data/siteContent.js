...
const siteContent = {
  ...
  livetSomStudent: {
    ...
    introP1: 'Før kandidatene våre kommer til Norge, gjennomfører de en opplæringsperiode i Alicante med fokus på språk, kultur og forberedelse til arbeid i Norge.',
    introP2: 'Dette er mer enn et kursopphold. Kandidatene går inn i et strukturert pensum med mål for å lære norsk til å bruke språket aktivt i praksis. Samtidig får de en forståelse for hvordan det er å leve og arbeide i Norge.',
    undervisningTitle: 'Undervisningen',
    undervisningP1: 'Undervisningen i Alicante omfatter 600 timer norsk og er lagt opp som en strukturert og praktisk opplæring. Fokuset er på hvordan språket brukes i arbeidshverdagen. Kandidatene jobber med situasjoner de vil møte i helsetjenester, og utvikler gode ferdigheter i både muntlig og skriftlig kommunikasjon.',
    undervisningP2: 'Dette gir et solid grunnlag for en mer fruktbar overgang til norsk arbeidsliv.',
    undervisningImageUrl: IMAGES.spanskAlicantePromenade,
    undervisningImageAlt: 'Undervisning i Alicante',
    helseTitle: 'Norsk for helsesektoren',
    helseP1: 'Som en del av programmet har Global Working utviklet en egen pensumbok som brukes i undervisningen. Boken er laget spesielt for dette programmet og er yrkesrettet mot stillinger som sykepleier og helsefagarbeider – med fokus på hverdagssituasjoner kandidatene faktisk vil møte i norsk helsetjeneste, som i hjemmesykepleien.',
    helseP2: 'Parallelt med den ordinære undervisningen følger kandidatene også et eget helsenorskfokus. Det som gjør undervisningen ekstra konkret, er at helsenorsk undervises av spanske sykepleiere som selv har gått gjennom Global Working-programmet og siden vendt tilbake til Spania for å lære opp nye kandidater. De kjenner språket, kulturen og overgangen til norsk arbeidsliv på nært hold og det gjenspeiles i undervisningen.',
    helseP3: 'Helsenorsk er en sentral del av programmet. Her jobber kandidatene målrettet med språk som brukes i norsk helsetjeneste, blant annet:',
    helseItems: [
      'Dialog med pasienter',
      'Fagterminologi',
      'Dokumentasjon og rapportering',
      'Samhandling med kollegaer',
    ],
    helseP4: 'Målet er at kandidatene ikke bare skal forstå språket, men kunne bruke det aktivt i relevante arbeidssituasjoner. Undervisningen inkluderer også simuleringer, hvor kandidatene øver på realistiske situasjoner de vil møte i møte med pasienter.',
    helseImageUrl: IMAGES.spanskAlicantePromenade,
    helseImageAlt: 'Helsenorsk undervisning',
    samtaleTitle: 'Samtaleassistenter',
    samtaleP1: 'En viktig del av oppholdet er møtet med våre norske samtaleassistenter. Dette er unge nordmenn som bor sammen med kandidatene i Spania og bidrar til språktrening gjennom daglige samtaler.',
    samtaleP2: 'Dette gir kandidatene mulighet til å bruke språket i mer uformelle situasjoner. Gjennom samtaler, felles måltider og aktiviteter får de innsikt i hvordan nordmenn kommuniserer i praksis. Det bidrar til:',
    samtaleItems: [
      'Mer naturlig språkflyt',
      'Bedre forståelse av norsk kultur',
      'Større trygghet i sosiale og profesjonelle situasjoner',
    ],
    samtaleP3: 'De som har rollen som samtaleassistenter er med på å gjøre språket levende i hverdagen. De bor sammen med deltakerne og bidrar til gode, felles opplevelser.',
    samtaleP4: 'Dette er en viktig del av hvordan vi forbereder kandidatene på livet og arbeidshverdagen i Norge.',
    samtaleImageUrl: IMAGES.spanskAlicantePromenade,
    samtaleImageAlt: 'Samtaleassistenter i Alicante',
    fellesskapTitle: 'Fellesskap og aktiviteter',
    fellesskapP1: 'En viktig del av oppholdet er miljøet rundt skolen. Kandidatene bor og tilbringer mye tid sammen, noe som skaper et sterkt sosialt fellesskap. Dette gir både støtte i læringsprosessen og en trygg ramme i en periode hvor mye er nytt.',
    fellesskapP2: 'Mange beskriver dette som en av de viktigste delene av oppholdet. Ved siden av undervisningen legges det til rette for aktiviteter som gir avkobling og sosialt samspill.',
    fellesskapLabel: 'Dette kan være:',
    fellesskapItems: [
      'Felles middager',
      'Utflukter i området',
      'Sosiale arrangementer',
      'Enkle aktiviteter organisert av skolen eller deltakerne selv',
    ],
    fellesskapP3: 'Aktivitetene er ikke hovedfokuset, men en viktig del av helheten.',
    fellesskapImageUrl: IMAGES.spanskAlicanteBeachPalms,
    fellesskapImageAlt: 'Fellesskap og aktiviteter i Alicante',
    ctaLabel: 'Kontakt',
    ctaTitle: 'Ønsker du å bli kjent med våre kandidater?',
    ctaP1: 'Oppholdet i Alicante er en viktig del av vår rekrutteringsmodell. Det er her kandidatene utvikler språk, ferdigheter og kunnskaper for å lykkes i norsk arbeidsliv. Bak hver kandidat ligger det en individuell motivasjon for å jobbe i Norge og bidra i kommunene de ansettes i.',
    ctaP2: 'Ta kontakt med oss for å få oversikt over kandidater som er tilgjengelige for intervju i deres kommune.',
    ctaButton: 'Send oss en melding',
  },

  helsenorsk: {
    breadcrumb: 'Helsenorsk',
    heroTitle: 'Helsenorsk',
    heroSubtitle: 'Yrkesrettet norsk for arbeid i helsesektoren. 650 timer med språkopplæring tilpasset hverdagen i norsk helsetjeneste.',
    heroImageUrl: IMAGES.spanskAlicantePromenade,
    heroImageAlt: 'Helsenorsk undervisning i Alicante',
    introTitle: 'Helsenorsk: yrkesrettet norsk for arbeid i helsesektoren',
    introP1: 'Helsenorsk er et sentralt spor i Global Workings opplæringsprogram i Alicante. Kurset er utviklet spesielt for sykepleiere og helsefagarbeidere som skal jobbe i Norge, og gir dem de språklige verktøyene de trenger for å fungere trygt og profesjonelt fra første arbeidsdag.',
    introP2: 'Gjennom 650 timer med yrkesrettet norskopplæring bygger kandidatene opp et fagspråk som er direkte knyttet til situasjoner de vil møte i norsk helsetjeneste. Fokuset er på praktisk kommunikasjon – ikke bare grammatikk, men evnen til å snakke med pasienter, samhandle med kollegaer og dokumentere presist.',
    praksisTitle: 'Språk som kan brukes i praksis',
    praksisP1: 'Undervisningen er bygd opp rundt reelle arbeidssituasjoner fra norsk helsevesen. Kandidatene jobber med konkrete scenarier de vil møte i hjemmesykepleie, sykehus og omsorgsboliger.',
    praksisItems: [
      'Mottak og overlevering av pasienter',
      'Kommunikasjon med pårørende',
      'Rapportskriving og journalføring',
      'Legemiddelhåndtering og medikamentsamtaler',
      'Samarbeid med tverrfaglige team',
    ],
    praksisP2: 'Målet er at kandidatene ikke bare forstår fagspråket, men kan bruke det aktivt og selvstendig i arbeidshverdagen.',
    situasjonerTitle: 'Realistiske situasjoner fra norsk helsevesen',
    situasjonerP1: 'En viktig del av helsenorskprogrammet er bruk av simuleringer og rollespill. Kandidatene øver på realistiske situasjoner hentet fra norsk helsetjeneste, som innkomstsamtaler, medikamentsamtaler og akutte situasjoner.',
    situasjonerP2: 'Simuleringene gjør at kandidatene utvikler språklig trygghet i kontrollerte omgivelser før de møter pasienter i Norge. De lærer å håndtere uventede situasjoner, stille oppfølgingsspørsmål og kommunisere tydelig under press.',
    situasjonerP3: 'Tilbakemeldinger fra arbeidsgivere i Norge viser at denne forberedelsen gjør en merkbar forskjell i oppstartsfasen.',
    situasjonerImageUrl: IMAGES.spanskAlicantePromenade,
    situasjonerImageAlt: 'Simulering av helsesituasjoner i undervisningen',
    undervisereTitle: 'Undervist av helsepersonell med erfaring fra Norge',
    undervisereP1: 'Det som gjør helsenorskundervisningen ekstra konkret, er at den ledes av spanske sykepleiere som selv har gjennomført Global Working-programmet og jobbet i norsk helsevesen.',
    undervisereP2: 'Disse lærerne kjenner overgangen fra Spania til Norge på nært hold. De vet hvilke språklige utfordringer som venter, hvilke situasjoner som krever ekstra forberedelse, og hvordan det føles å starte i en ny rolle i et nytt land.',
    undervisereP3: 'Denne kombinasjonen av faglig kompetanse og personlig erfaring gir undervisningen en troverdighet og relevans som er vanskelig å oppnå på andre måter.',
    grunnlagTitle: 'Et solid språklig grunnlag før oppstart',
    grunnlagP1: 'Global Working har utviklet en egen pensumbok for helsenorskprogrammet. Boken er laget spesielt for dette kurset og dekker de viktigste temaene kandidatene trenger å beherske før de starter i jobb.',
    grunnlagP2: 'Pensum er yrkesrettet mot stillinger som sykepleier og helsefagarbeider, med fokus på hverdagssituasjoner fra hjemmesykepleie, sykehus og kommunale helsetjenester.',
    grunnlagItems: [
      'Dialog med pasienter i ulike aldersgrupper',
      'Fagterminologi tilpasset norsk helsetjeneste',
      'Dokumentasjon, rapportering og journalføring',
      'Tverrfaglig samhandling og møtekultur',
      'Etiske problemstillinger og taushetsplikt',
    ],
    grunnlagP3: 'Når kandidatene avslutter programmet, har de et solid språklig grunnlag som gjør dem i stand til å kommunisere trygt og profesjonelt i norsk arbeidshverdag.',
    grunnlagImageUrl: IMAGES.spanskAlicantePromenade,
    grunnlagImageAlt: 'Helsenorsk pensumbok og undervisningsmateriell',
    ctaLabel: 'Kontakt',
  ...
  footer: {
    ...
    social: [
      ...
      { label: 'YouTube', href: 'https://www.youtube.com/@GlobalWorkingNorge/featured' },
    ],
    links: {
      Tjenester: [
        { label: 'Vår rekrutteringsmodell', href: '/vr-rekrutteringsmodell' },
