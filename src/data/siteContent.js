...
const siteContent = {
  ...
  helsenorsk: {
    ...
    heroImageUrl: IMAGES.enfermeria,
    heroImageAlt: 'Helsenorsk undervisning i Alicante',
    introTitle: 'Helsenorsk: yrkesrettet norsk for arbeid i helsesektoren',
    introP1: 'Hos Global Working lærer kandidatene norsk med et tydelig mål: å kunne bruke språket trygt i arbeidshverdagen i norsk helsetjeneste.',
    introP2: 'Derfor er helsenorsk en sentral del av språkopplæringen vår. Her får sykepleiere, helsefagarbeidere og annet helsepersonell undervisning som er spesielt rettet mot de ulike situasjonene de vil møte i jobb i norske kommuner.',
    introP3: 'Gjennom programmet gjennomfører kandidatene opptil 650 undervisningstimer i norsk. I tillegg til ordinær språkundervisning jobber de målrettet med helsefaglig språk, fagterminologi og kommunikasjon i relevante arbeidssituasjoner.',
    praksisTitle: 'Språk som kan brukes i praksis',
    praksisP1: 'Helsenorsk handler ikke bare om å lære medisinske ord og uttrykk. Kandidatene øver på å forstå, forklare og bruke språket aktivt i situasjoner fra norsk helsevesen.',
    praksisP2: 'Undervisningen er delt inn i relevante temaer og moduler som speiler arbeidshverdagen i kommunale helsetjenester.',
    praksisP3: 'I én modul kan kandidatene for eksempel jobbe med norsk språk knyttet til ulike typer smerter, smertebehandling, livets sluttfase, sorg og kommunikasjon med pasienter og pårørende. De lærer også ord og uttrykk knyttet til tiltaksplaner, ulike typer sår og praktiske caseoppgaver.',
    praksisListIntro: 'I undervisningen jobber de blant annet med:',
    praksisItems: [
      'dialog med pasienter og pårørende',
      'rapportering og dokumentasjon',
      'fagterminologi og helserelaterte uttrykk',
      'samarbeid og kommunikasjon med kollegaer',
      'vanlige situasjoner fra hjemmesykepleie, sykehjem og kommunale helsetjenester',
    ],
    praksisP4: 'Målet er at kandidatene skal kunne kommunisere tydelig, forstå beskjeder og bidra aktivt i arbeidshverdagen fra første periode i jobb.',
    situasjonerTitle: 'Realistiske situasjoner fra norsk helsevesen',
    situasjonerP1: 'Undervisningen er praktisk lagt opp. Kandidatene øver på scenarier de kan møte i norsk helsetjeneste, som samtaler med pasienter, rapportering til kollegaer, forståelse av helseinformasjon og håndtering av ulike behov hos brukere og pasienter.',
    situasjonerP2: 'Gjennom simuleringer og muntlige øvelser får kandidatene trene på både språk, trygghet og faglig kommunikasjon. Dette gir dem et mer realistisk møte med norsk arbeidsliv og gjør overgangen til jobb i Norge lettere.',
    situasjonerImageUrl: IMAGES.helseSituasjon,
    situasjonerImageAlt: 'Sykepleier i samtale med eldre pasient på sykehjem',
    undervisereTitle: 'Undervist av helsepersonell med erfaring fra Norge',
    undervisereP1: 'En viktig del av helsenorskundervisningen er at den ledes av spanske sykepleiere som selv har gått gjennom Global Working-programmet og senere jobbet i Norge.',
    undervisereP2: 'De kjenner både språket, kulturen og overgangen til norsk arbeidsliv. Denne erfaringen gjør undervisningen konkret, relevant og tett knyttet til situasjonene kandidatene faktisk vil møte i jobb.',
    grunnlagTitle: 'Et solid språklig grunnlag før oppstart',
    grunnlagP1: 'Global Working har utviklet egne undervisningsressurser og en egen pensumbok tilpasset helsepersonell som skal jobbe i Norge. Innholdet bygger på mange års erfaring med språkopplæring, rekruttering og oppfølging av kandidater til norsk helsesektor.',
    grunnlagP2: 'Gjennom kombinasjonen av norskundervisning, helsenorsk, samtaletrening og kulturforståelse får kandidatene et solid grunnlag før de starter i jobb. Det gir både kandidat og arbeidsgiver en tryggere start.',
    grunnlagItems: [],
  ...
  navbar: {
    links: [
      { label: 'Rekruttering', href: '/vr-rekrutteringsmodell' },
